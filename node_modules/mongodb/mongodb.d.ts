...
export declare class GridFSBucketWriteStream extends Writable implements NodeJS.WritableStream {
     ...
     */
    write(chunk: Buffer_2 | string): boolean;
    write(chunk: Buffer_2 | string, callback: Callback<void>): boolean;
    write(chunk: Buffer_2 | string, encoding: BufferEncoding | undefined): boolean;
    write(chunk: Buffer_2 | string, encoding: BufferEncoding | undefined, callback: Callback<void>): boolean;
    /**
    ...
    end(chunk: Buffer_2): this;
    end(callback: Callback<GridFSFile | void>): this;
    end(chunk: Buffer_2, callback: Callback<GridFSFile | void>): this;
    end(chunk: Buffer_2, encoding: BufferEncoding): this;
    end(chunk: Buffer_2, encoding: BufferEncoding | undefined, callback: Callback<GridFSFile | void>): this;
}
 ...
 */
export declare type NestedPaths<Type, Depth extends number[]> = Depth['length'] extends 8 ? [] : Type extends string | number | bigint | boolean | Date | RegExp | Buffer_2 | Uint8Array | ((...args: any[]) => any) | {
    _bsontype: string;
